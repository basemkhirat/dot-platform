...
<div class="row">
    <div class="col-md-12 ibox float-e-margins">
        ...
        <div class="ibox-title">
            ...
            <div class="col-md-6">
                <button style="margin-top: -8px;" data-loading-text="<?php echo trans("admin::common.saving"); ?>" class="btn btn-primary pull-right" id="save-order"><?php echo trans("admin::common.save_order"); ?></button>
            </div>
        </div>
        <?php
        ...
        function get_menu_items($items, $depth = 0) {
            foreach ($items as $item) {
                ...
                <li class="group iterate-item dd-item" id="list-<?php echo $key ?>" data-icon="<?php echo $icon; ?>" data-url="<?php echo $url; ?>">
