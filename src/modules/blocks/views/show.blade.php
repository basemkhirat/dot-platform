    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo route("admin.blocks.show"); ?>"><?php echo trans("blocks::blocks.blocks") ?>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <select name="sort" class="form-control chosen-select chosen-rtl">
                                <option
                                    value="name"
                                    <?php if ($sort == "name") { ?> selected='selected' <?php } ?>><?php echo ucfirst(trans("blocks::blocks.attributes.name")); ?></option>
                            </select>
                            <select name="order" class="form-control chosen-select chosen-rtl">
                                <option
                                    value="DESC"
                                    <?php if (Request::get("order") == "DESC") { ?> selected='selected' <?php } ?>><?php echo trans("blocks::blocks.desc"); ?></option>
                                <option
                                    value="ASC"
                                    <?php if (Request::get("order") == "ASC") { ?> selected='selected' <?php } ?>><?php echo trans("blocks::blocks.asc"); ?></option>
                            </select>
                            <button type="submit"
                                    class="btn btn-primary"><?php echo trans("blocks::blocks.order"); ?></button>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                                <select class="form-control per_page_filter">
                                    <option value="" selected="selected">
                                        -- <?php echo trans("blocks::blocks.per_page") ?>--
                                    </option>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <a <?php /* data-toggle="tooltip" data-placement="bottom" */ ?>
                                           title="<?php echo trans("blocks::blocks.delete"); ?>"
