...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5">
        <h2>
            ...
            <?php
            if ($block) {
                echo trans("blocks::blocks.edit");
            } else {
                echo trans("blocks::blocks.add_new");
            }
            ?>
        </h2>
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo URL::to(ADMIN . "/blocks"); ?>"><?php echo trans("blocks::blocks.blocks"); ?></a>
            </li>
            <li class="active">
                <strong>
                    <?php
...
<form action="" method="post" class="BlocksForm">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="name" type="text" value="<?php echo @Request::old("name", $block->name); ?>" class="form-control" id="input-name" placeholder="<?php echo trans("blocks::blocks.attributes.name") ?>">
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group" style="position:relative">
                        <input type="hidden" name="tags" id="tags_names" value="<?php echo join(",", $block_tags); ?>">
                        <ul id="mytags"></ul>
                    </div>
                </div>
            </div>
    ...
    <div>
        <div class="container-fluid">
            <div class="form-group">
                <input type="submit" class="pull-left btn btn-flat btn-primary" value="<?php echo trans("blocks::blocks.save_block") ?>" />
            </div>
        </div>
    </div>
