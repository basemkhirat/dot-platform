...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo URL::to(ADMIN . "/polls"); ?>"><?php echo trans("polls::polls.polls") ?>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="form-group">
                    <select name="sort" class="form-control chosen-select chosen-rtl">
                        <option
                            value="id" <?php if ($sort == "id") { ?> selected='selected' <?php } ?>><?php echo trans("polls::polls.sort_by"); ?></option>

                        <option
                            value="status" <?php if ($sort == "status") { ?> selected='selected' <?php } ?>><?php echo trans("polls::polls.attributes.status"); ?></option>

                        <option
                            value="title" <?php if ($sort == "title") { ?> selected='selected' <?php } ?>><?php echo trans("polls::polls.attributes.title"); ?></option>
                        <option
                            value="votes" <?php if ($sort == "votes") { ?> selected='selected' <?php } ?>><?php echo trans("polls::polls.attributes.votes"); ?></option>
                    </select>
                    <select name="order" class="form-control chosen-select chosen-rtl">
                        <option
                            value="DESC" <?php if ($order == "DESC") { ?> selected='selected' <?php } ?>><?php echo trans("polls::polls.desc"); ?></option>
                        <option
                            value="ASC" <?php if ($order == "ASC") { ?> selected='selected' <?php } ?>><?php echo trans("polls::polls.asc"); ?></option>
                    </select>
                    <button type="submit" class="btn btn-primary"><?php echo trans("polls::polls.order"); ?></button>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary"><?php echo trans("polls::polls.filter"); ?></button>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
