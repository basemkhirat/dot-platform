        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <h2>
                    ...
                    <?php echo $poll ? trans("polls::polls.edit") : trans("polls::polls.add_new"); ?>
                </h2>
                <ol class="breadcrumb">
                    <li>
                        <a href="<?php echo route("admin.polls.show"); ?>"><?php echo trans("polls::polls.polls"); ?></a>
                    </li>
                    <li class="active">
                        <strong>
                            <?php echo $poll ? trans("polls::polls.edit") : trans("polls::polls.add_new"); ?>
            ...
            <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 text-right">
                ...
                <?php } ?>
                    ...
                    <button type="submit" class="btn btn-flat btn-danger btn-main">
                        ...
                        <?php echo trans("polls::polls.save_poll") ?>
                    </button>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="title" type="text"
                                       value="<?php echo @Request::old("title", $poll->title); ?>"
                                    ...
                                    <div class="row poll-row">
                                        ...
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
                                            <input type="hidden" name="images[]"
                                                   value="<?php echo $answer->image ? $answer->image->id : 0 ?>"/>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group switch-row">
                                ...
                                <div class="col-sm-3">
                                    <input <?php if (@Request::old("status", $poll->status)) { ?> checked="checked"
                                           <?php } ?>
