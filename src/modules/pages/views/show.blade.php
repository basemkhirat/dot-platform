...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo URL::to(ADMIN . "/pages"); ?>"><?php echo trans("pages::pages.pages") ?>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="form-group">
                    <select name="sort" class="form-control chosen-select chosen-rtl">
                        <option
                        <option
                            value="title" <?php if ($sort == "title") { ?> selected='selected' <?php } ?>><?php echo ucfirst(trans("pages::pages.attributes.title")); ?></option>
                        <option
                            value="created_at" <?php if ($sort == "created_at") { ?> selected='selected' <?php } ?>><?php echo ucfirst(trans("pages::pages.attributes.created_at")); ?></option>
                    </select>
                    <select name="order" class="form-control chosen-select chosen-rtl">
                        <option
                            value="DESC" <?php if ($sort == "DESC") { ?> selected='selected' <?php } ?>><?php echo trans("pages::pages.desc"); ?></option>
                        <option
                            value="ASC" <?php if ($sort == "ASC") { ?> selected='selected' <?php } ?>><?php echo trans("pages::pages.asc"); ?></option>
                    </select>
                    <button type="submit" class="btn btn-primary"><?php echo trans("pages::pages.order"); ?></button>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary"><?php echo trans("pages::pages.filter"); ?></button>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4">
                <form action="" method="get" class="search_form">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">search_pages
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <select name="post_status" id="post_status"
                                ...
                                <option value="" selected="selected">-- <?php echo trans("pages::pages.per_page") ?>
                                    --
                                </option>
