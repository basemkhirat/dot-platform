<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
        <ul class="nav nav-tabs option-tabs">
            ...
            <li <?php if ($option_page == "plugins") { ?>class="active"<?php } ?>><a  href="<?php echo route("admin.options.plugins"); ?>"><i class="fa fa-puzzle-piece"></i>  <span class="hidden-sm hidden-xs hidden-md">
