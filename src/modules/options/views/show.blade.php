                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="site_name" type="text" value="<?php echo @Request::old("site_name", Config::get("site_name")); ?>" class="form-control" id="site_name" placeholder="<?php echo trans("options::options.attributes.site_name") ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="site_slogan"><?php echo trans("options::options.attributes.site_slogan") ?></label>
                                        <input name="site_slogan" type="text" value="<?php echo @Request::old("site_slogan", Config::get("site_slogan")); ?>" class="form-control" id="site_slogan" placeholder="<?php echo trans("options::options.attributes.site_slogan") ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="site_email"><?php echo trans("options::options.attributes.site_email") ?></label>
                                        <input name="site_email" type="text" value="<?php echo @Request::old("site_email", Config::get("site_email")); ?>" class="form-control" id="site_email" placeholder="<?php echo trans("options::options.attributes.site_email") ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="site_copyrights"><?php echo trans("options::options.attributes.site_copyrights") ?></label>
                                        <input name="site_copyrights" type="text" value="<?php echo @Request::old("site_copyrights", Config::get("site_copyrights")); ?>" class="form-control" id="site_copyrights" placeholder="<?php echo trans("options::options.attributes.site_copyrights") ?>">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="app_locale" class="form-control chosen-select chosen-rtl" name="app_locale">
                                            <?php foreach (Config::get("admin.locales") as $code => $lang) { ?>
                                                <option value="<?php echo $code; ?>" <?php if (Config::get("app.locale") == $code) { ?> selected="selected" <?php } ?>><?php echo $lang["title"]; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br/>
                                            <textarea class="form-control" id="offline_message" name="offline_message" placeholder="<?php echo trans("options::options.attributes.offline_message") ?>"><?php echo @Request::old("offline_message", Config::get("offline_message")); ?></textarea>
                                        </div>
