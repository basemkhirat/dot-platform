                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group switch-row">
                                ...
                                <div class="col-sm-2">
                                    <input <?php if (Config::get("media.media_thumbnails")) { ?> checked="checked" <?php } ?>
                                        type="checkbox" id="media_thumbnails" name="media_thumbnails" value="1"
                            ...
                            <div class="form-group">
                                ...
                                <select id="media_resize_mode" class="form-control chosen-select chosen-rtl"
                                    ...
                                    <?php foreach (["resize", "resize_crop", "color_background", "gradient_background", "blur_background"] as $mode) { ?>
                                        <option
                                            value="<?php echo $mode; ?>" <?php if (Config::get("media.resize_mode") == $mode) { ?> selected="selected" <?php } ?>><?php echo trans("options::options.resize_mode_" . $mode) ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="row gradient-background-area" style="display: none">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="resize_gradient_second_color" type="text"
                                           ...
                                           class="form-control color-input" id="resize_gradient_second_color"
                        ...
                        <div class="col-md-6">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group switch-row">
                                    ...
                                    <div class="col-sm-2">
                                        <input <?php if (Config::get("media.s3.status")) { ?> checked="checked" <?php } ?>
                                ...
                                <div class="form-group switch-row">
                                    ...
                                    <div class="col-sm-2">
                                        <input <?php if (Config::get("media.s3.delete_locally")) { ?> checked="checked" <?php } ?>
                                            type="checkbox" id="s3_delete_locally" name="s3_delete_locally" value="1"
                                            class="switcher switcher-sm">
                                    </div>
                                </div>
