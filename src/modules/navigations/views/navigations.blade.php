...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7 text-right">
        ...
        <span
            class="btn-label icon fa fa-plus"></span> &nbsp; <?php echo trans("navigations::navigations.add_new"); ?>
        </a>
        ...
        <div class="modal-content">
            <form class="create_nav_menu">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" data-loading-text="<?php echo trans("navigations::navigations.loading"); ?>"
                                ...
                                <div class="col-md-9">
                                    <select id="input-type" class="form-control chosen-select chosen-rtl nav-selector"
                                        ...
                                        <?php foreach ($navs as $menu) { ?>
                                            <option
                                                value="<?php echo $menu->id; ?>" <?php if ($id == $menu->id) { ?> selected="selected" <?php } ?>><?php echo $menu->name; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
            ...
            class="btn-label icon fa fa-edit"></span>
                    ...
                    <form class="nav-items-form">
                        ...
                        <div class="dd-handle" style="overflow: hidden">
                            ...
                            <button type="submit" class="btn btn-primary pull-right" data-loading-text="<?php echo trans("navigations::navigations.loading"); ?>">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="panel-group" id="accordion">
                        <?php foreach (["post", "page", "category", "tag"] as $type) { ?>
...
<script src="<?php echo assets("admin::js/plugins/nestable/jquery.nestable.js"); ?>"></script>
