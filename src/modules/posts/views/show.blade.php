    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="<?php echo route("admin.posts.show"); ?>"><?php echo trans("posts::posts.posts") ?>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            <select name="sort" class="form-control chosen-select chosen-rtl">
                                <option
                                    value="title"
                                    <?php if ($sort == "title") { ?> selected='selected' <?php } ?>><?php echo ucfirst(trans("posts::posts.attributes.title")); ?></option>
                                <option
                                    value="created_at"
                                    <?php if ($sort == "created_at") { ?> selected='selected' <?php } ?>><?php echo ucfirst(trans("posts::posts.attributes.created_at")); ?></option>
                            </select>
                            <select name="order" class="form-control chosen-select chosen-rtl">
                                <option
                                    value="DESC"
                                    <?php if ($order == "DESC") { ?> selected='selected' <?php } ?>><?php echo trans("posts::posts.desc"); ?></option>
                                <option
                                    value="ASC"
                                    <?php if ($order == "ASC") { ?> selected='selected' <?php } ?>><?php echo trans("posts::posts.asc"); ?></option>
                            </select>
                            <button type="submit"
                                    class="btn btn-primary"><?php echo trans("posts::posts.order"); ?></button>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <div class="form-group">
                            ...
                            <select name="block_id" class="form-control chosen-select chosen-rtl">
                                ...
                                <option <?php if (Request::get("block_id") == $block->id) { ?> selected='selected'
                                        <?php } ?>
                            ...
                            <button type="submit"
                                    class="btn btn-primary"><?php echo trans("posts::posts.filter"); ?></button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <form action="" method="get" class="search_form">
                            ...
                            <div class="input-group date datetimepick col-sm-6 pull-left" style="margin-top: 5px">
                                ...
                                <input name="from" type="text" value="<?php echo @Request::get("from"); ?>"
                                       class="form-control" id="input-from"
                                       placeholder="<?php echo trans("posts::posts.from") ?>">
                            </div>

                            <div class="input-group date datetimepick col-sm-6 pull-left" style="margin-top: 5px">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <input name="to" type="text" value="<?php echo @Request::get("to"); ?>"
                                       class="form-control" id="input-to"
                                       placeholder="<?php echo trans("posts::posts.to") ?>">
                            </div>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <?php echo trans("posts::posts.page"); ?>
