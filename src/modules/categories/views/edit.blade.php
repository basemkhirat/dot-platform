...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7 text-right">
        ...
        <a href="<?php echo route("admin.categories.show"); ?>" class="btn btn-primary btn-labeled btn-main">
                ...
                <div class="panel-body form-group">
                    <div class="row post-image-block">
                        ...
                        <a class="post-image-preview" href="javascript:void(0)">
                            <img width="100%" height="130px" class="post-image" src="<?php if ($category and @ $category->image->id != "") { ?> <?php echo thumbnail(@$category->image->path); ?> <?php } else { ?> <?php echo assets("admin::default/image.png"); ?><?php } ?>">
                        </a>
                    </div>
                </div>
            </div>
